...
/// <summary>
/// Represents the configuration of a stored procedure that will be reflectively configured by the <see cref="ModelBuilderExtensions.LoadReflectiveProcedures(Microsoft.EntityFrameworkCore.ModelBuilder)"/> method.
/// </summary>
